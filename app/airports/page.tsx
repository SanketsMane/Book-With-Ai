            ...
            <div className="lg:ml-72 min-h-screen p-8 md:p-12">
                <div className="max-w-4xl mx-auto space-y-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Airport Analyzer</h1>
                            <p className="text-gray-500 dark:text-gray-400">Get insights on airport navigation and delays.</p>
                        </div>
                    </div>
